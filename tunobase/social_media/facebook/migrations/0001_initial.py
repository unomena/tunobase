...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'facebook_facebookuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='facebook_user', unique=True, to=orm['authentication.EndUser'])),
            ('facebook_user_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'facebook', ['FacebookUser'])


    def backwards(self, orm):
        # Deleting model 'FacebookUser'
        db.delete_table(u'facebook_facebookuser')
    ...
    models = {
        ...
        u'facebook.facebookuser': {
            ...
            'facebook_user_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'facebook_user'", 'unique': 'True', 'to': u"orm['authentication.EndUser']"})
        },
