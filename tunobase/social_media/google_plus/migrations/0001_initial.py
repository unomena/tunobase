...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'google_plus_googleplususer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='google_plus_user', unique=True, to=orm['authentication.EndUser'])),
            ('google_user_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('token_response', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('access_token_expiry_timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'google_plus', ['GooglePlusUser'])


    def backwards(self, orm):
        # Deleting model 'GooglePlusUser'
        db.delete_table(u'google_plus_googleplususer')
    ...
    models = {
        ...
        u'google_plus.googleplususer': {
            ...
            'token_response': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
