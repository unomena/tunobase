...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'twitter_twitteruser', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='twitter_user', unique=True, to=orm['authentication.EndUser'])),
    ...
    models = {
        ...
        u'twitter.twitteruser': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'twitter_user'", 'unique': 'True', 'to': u"orm['authentication.EndUser']"})
        }
    }
