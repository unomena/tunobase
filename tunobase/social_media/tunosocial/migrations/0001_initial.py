...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Like'
        db.create_table(u'tunosocial_like', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tunosocial_likes', null=True, to=orm['authentication.EndUser'])),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tunosocial', ['Like'])

        # Adding unique constraint on 'Like', fields ['user', 'content_type', 'object_pk']
        db.create_unique(u'tunosocial_like', ['user_id', 'content_type_id', 'object_pk'])


    def backwards(self, orm):
        # Removing unique constraint on 'Like', fields ['user', 'content_type', 'object_pk']
        db.delete_unique(u'tunosocial_like', ['user_id', 'content_type_id', 'object_pk'])

        # Deleting model 'Like'
        db.delete_table(u'tunosocial_like')
    ...
    models = {
        ...
        u'tunosocial.like': {
            'Meta': {'unique_together': "(('user', 'content_type', 'object_pk'),)", 'object_name': 'Like'},
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tunosocial_likes'", 'null': 'True', 'to': u"orm['authentication.EndUser']"})
        }
    }

    complete_apps = ['tunosocial']