...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'EULA'
        m2m_table_name = db.shorten_name(u'eula_eula_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eula', models.ForeignKey(orm[u'eula.eula'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['eula_id', 'site_id'])
        ...
        db.create_table(u'eula_eulaversion', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eulaversion_created_content', null=True, to=orm['authentication.EndUser'])),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eulaversion_modified_content', null=True, to=orm['authentication.EndUser'])),
        ...
        # Adding model 'UserEULA'
        db.create_table(u'eula_usereula', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='signed_eulas', to=orm['authentication.EndUser'])),
            ('eula', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eula.EULAVersion'])),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('signed_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('eula_content_copy', self.gf('ckeditor.fields.RichTextField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='content_type_set_for_usereula', null=True, to=orm['contenttypes.ContentType'])),
            ('object_pk', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'eula', ['UserEULA'])

        # Adding unique constraint on 'UserEULA', fields ['user', 'eula']
        db.create_unique(u'eula_usereula', ['user_id', 'eula_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserEULA', fields ['user', 'eula']
        db.delete_unique(u'eula_usereula', ['user_id', 'eula_id'])

        # Deleting model 'EULA'
        db.delete_table(u'eula_eula')

        # Removing M2M table for field sites on 'EULA'
        db.delete_table(db.shorten_name(u'eula_eula_sites'))

        # Deleting model 'EULAVersion'
        db.delete_table(u'eula_eulaversion')

        # Deleting model 'UserEULA'
        db.delete_table(u'eula_usereula')
    ...
    models = {
        ...
        u'eula.eulaversion': {
            'Meta': {'ordering': "['-publish_at']", 'object_name': 'EULAVersion'},
            'content': ('ckeditor.fields.RichTextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'eulaversion_created_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'eulaversion_modified_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
        ...
        u'eula.usereula': {
            'Meta': {'unique_together': "(('user', 'eula'),)", 'object_name': 'UserEULA'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'content_type_set_for_usereula'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"}),
            'eula': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eula.EULAVersion']"}),
            'eula_content_copy': ('ckeditor.fields.RichTextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'signed_eulas'", 'to': u"orm['authentication.EndUser']"})
        },
