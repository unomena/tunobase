...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailer_outboundemail', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='outbound_emails', null=True, to=orm['auth.EndUser'])),
    ...
    models = {
        ...
        u'mailer.outboundemail': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'outbound_emails'", 'null': 'True', 'to': u"orm['auth.EndUser']"})
        },
