...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentModel.image_name'
        db.add_column(u'core_contentmodel', 'image_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentModel.image_name'
        db.delete_column(u'core_contentmodel', 'image_name')
