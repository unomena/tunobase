...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_blogentry', (
            (u'contentmodel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.ContentModel'], unique=True, primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['blog.Blog'])),
            ('authors_alternate', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal(u'blog', ['BlogEntry'])

        # Adding M2M table for field author_users on 'BlogEntry'
        m2m_table_name = db.shorten_name(u'blog_blogentry_author_users')
        ...
        db.create_unique(m2m_table_name, ['blogentry_id', 'enduser_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field author_users on 'BlogEntry'
        db.delete_table(db.shorten_name(u'blog_blogentry_author_users'))
    ...
    models = {
        ...
        u'blog.blog': {
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'Blog', '_ormbases': [u'core.ContentModel']},
            u'contentmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.ContentModel']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'blog.blogentry': {
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'BlogEntry', '_ormbases': [u'core.ContentModel']},
            'author_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'blog_entries_authored'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['authentication.EndUser']"}),
            'authors_alternate': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['blog.Blog']"}),
            u'contentmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.ContentModel']", 'unique': 'True', 'primary_key': 'True'})
        },
