...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vacancy.order'
        db.add_column(u'company_info_vacancy', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'CompanyMemberPosition.order'
        db.add_column(u'company_info_companymemberposition', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ContactMessage.user'
        db.add_column(u'company_info_contactmessage', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.EndUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vacancy.order'
        db.delete_column(u'company_info_vacancy', 'order')

        # Deleting field 'CompanyMemberPosition.order'
        db.delete_column(u'company_info_companymemberposition', 'order')

        # Deleting field 'ContactMessage.user'
        db.delete_column(u'company_info_contactmessage', 'user_id')
    ...
    models = {
        ...
        u'company_info.companymemberposition': {
            'Meta': {'ordering': "['order']", 'object_name': 'CompanyMemberPosition'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        u'company_info.contactmessage': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.EndUser']", 'null': 'True', 'blank': 'True'})
        },
        u'company_info.vacancy': {
            'Meta': {'ordering': "['order']", 'object_name': 'Vacancy', '_ormbases': [u'core.ContentModel']},
            u'contentmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.ContentModel']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'core.contentmodel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'image_name': ('django.db.models.fields.CharField', [], {'max_length': '512', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
