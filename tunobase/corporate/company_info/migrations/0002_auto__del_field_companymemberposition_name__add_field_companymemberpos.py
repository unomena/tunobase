...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyMemberPosition.name'
        db.delete_column(u'company_info_companymemberposition', 'name')

        # Adding field 'CompanyMemberPosition.title'
        db.add_column(u'company_info_companymemberposition', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CompanyMemberPosition.slug'
        db.add_column(u'company_info_companymemberposition', 'slug',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CompanyMemberPosition.name'
        raise RuntimeError("Cannot reverse this migration. 'CompanyMemberPosition.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CompanyMemberPosition.name'
        db.add_column(u'company_info_companymemberposition', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'CompanyMemberPosition.title'
        db.delete_column(u'company_info_companymemberposition', 'title')

        # Deleting field 'CompanyMemberPosition.slug'
        db.delete_column(u'company_info_companymemberposition', 'slug')
    ...
    models = {
        ...
        u'company_info.companymember': {
            'Meta': {'ordering': "['order']", 'object_name': 'CompanyMember', '_ormbases': [u'core.ContentModel']},
        ...
        u'company_info.companymemberposition': {
            'Meta': {'ordering': "['-publish_at']", 'object_name': 'CompanyMemberPosition'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'company_info.vacancy': {
            'Meta': {'object_name': 'Vacancy', '_ormbases': [u'core.ContentModel']},
            u'contentmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.ContentModel']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'core.contentmodel': {
            'Meta': {'object_name': 'ContentModel'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_content'", 'null': 'True', 'to': u"orm['auth.EndUser']"}),
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'modified_content'", 'null': 'True', 'to': u"orm['auth.EndUser']"}),
